...
categories_data = [
    {
        ...
        "fields": {
            ...
            "created_at": str(timezone.now() + timedelta(days=randint(-200, 0)) + timedelta(hours=randint(-9, 9)) + timedelta(minutes=randint(-20, 20)) + timedelta(seconds=randint(-20, 20))),
            "updated_at": str(timezone.now() + timedelta(days=randint(1, 200)) + timedelta(hours=randint(-9, 9)) + timedelta(minutes=randint(-20, 20)) + timedelta(seconds=randint(-20, 20))),
        }
    },
    {
        "model": "product.Category",
