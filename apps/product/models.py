...
class Category(AbstractPublicIdMixin, AbstractCreatedUpdatedMixin):
    ...
    thumbnail = ResizedImageField(_('thumbnail'), size=[200, 200], null=True, blank=True, upload_to=thumbnail_path, force_format='PNG')
...
class Product(AbstractPublicIdMixin, AbstractCreatedUpdatedMixin):
    ...
    thumbnail = ResizedImageField(_('thumbnail'), size=[400, 400], null=True, blank=True, upload_to=thumbnail_path)
