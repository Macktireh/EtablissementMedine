...
def succesMessage() -> Dict[str, str]:
    return {
        ...
        "LOGIN_SUCCESS": toggleLangMsg(msgFR="Connexion réussie.", msgEN="Login success."),
        ...
        "PASSWORD_RESET_SUCCESSFULLY": toggleLangMsg(
            msgFR="Réinitialisation du mot de passe réussie.", msgEN="Password reset successfully."
        ),
        ...
        "LOGOUT_SUCCESS": toggleLangMsg(msgFR="Déconnexion réussie.", msgEN="Logout success."),
    }
...
def failMessage() -> Dict[str, str]:
    return {
        ...
        "THE_TELEPHONE_NUMBER_ALREADY_EXISTS": toggleLangMsg(
            msgFR="Le numéro de télépnone existe déjà.", msgEN="The telephone number already exists."
        ),
        "THE_EMAIL_ADDRESS_DOES_NOT_EXIST": toggleLangMsg(
            msgFR="L'adresse e-mail n'existe pas.", msgEN="The email address does not exist."
        ),
        "PLEASE_CONFIRM_YOUR_ADDRESS_EMAIL": toggleLangMsg(
            msgFR="Veuillez confirmer votre adresse e-mail.", msgEN="Please confirm your address email."
        ),
        "PLEASE_ENTER_A_VALID_EMAIL_ADDRESS": toggleLangMsg(
            msgFR="Veuillez entrer une adresse email valide.", msgEN="Please enter a valid email address."
        ),
        "THE_EMAIL_ADDRESS_ALREADY_EXISTS": toggleLangMsg(
            msgFR="L'adresse email existe déjà.", msgEN="The email address already exists."
        ),
        "THE_TEMPLATE_EMAIL_HAS_NOT_BEEN_FOUND": toggleLangMsg(
            msgFR="Le template email n'a pas été trouvé.", msgEN="The template email has not been found."
        ),
        "THE_EMAIL_SERVER_IS_NOT_WORKING": toggleLangMsg(
            msgFR="Le serveur de messagerie ne fonctionne pas.", msgEN="The email server is not working."
        ),
        "THE_EMAIL_OR_PASSWORD_IS_INCORRECT": toggleLangMsg(
            msgFR="Email ou le mot de passe est incorrect.", msgEN="The email or password is incorrect."
        ),
